...
| REP-002 | 6 | README central explica stack e subida completa, validada por execução do zero. | Em andamento | docs/ETAPA-4.md; docs/ETAPA-5.md | prepare-stage4/5.ps1; compose up --build; smokes correspondentes | Ensaios isolados de produtores e Redis validados; métricas, Kong e Kind pendentes | 2026-09-14 |
