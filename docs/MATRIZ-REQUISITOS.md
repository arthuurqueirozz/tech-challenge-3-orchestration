...
| REP-002 | 6 | README central explica stack e subida completa, validada por execução do zero. | Em andamento | docs/ETAPA-4.md; docs/EVIDENCIAS-ETAPA-4.md | prepare-stage4.ps1; compose up --build; stage4-smoke.ps1 | Ensaio isolado de produtores validado; Redis, métricas, Kong e Kind pendentes | 2026-09-14 |
